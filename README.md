...
- 🔬 **Engineer by training**, explorer by nature. I enjoy experimenting with ideas that connect **LLMs**, **vision models**, and **automation**.
- ⚙️ Skilled in designing full ML pipelines — from raw data to production-ready APIs.
- 🤖 Focused on **deep learning**, **OCR**, **LLMs**, and **end-to-end system design**.
- 🛠️ Advocate of clean, reusable code and tools that scale.
- 🧠 Firm believer that **understanding is better than memorizing**, and **shipping beats perfection**.
...
**ML/DL:** PyTorch, TensorFlow, OpenCV, Hugging Face, Ultralytics YOLO  
...
I’m constantly learning, building, and refining — and I try to share parts of that journey here on GitHub.  
Hope you find something useful or inspiring here. 🙌

_“Build thoughtfully. Automate responsibly. Learn constantly.”_
